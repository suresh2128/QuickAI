...
const Aitools = () => {
    ...
    const {user} = useUser()
  return (
    <div className='px-4 sm:[x-20 xl:px-32 my-24'>
        <div className='text-center'>
            <h2 className='text-slate-700 text-[42px] font-semibold'>Powerful AI Tools</h2>
            <p className='text-gray-500 amx-w-lg-max mx-auto'>Everything you need to create,enhance, and optimize your content with  <br/>cutting-edgr AI technology.</p>
        </div>
